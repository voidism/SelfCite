...
def get_tokenizer(
    ...
    elif auto_set_chat_template and tokenizer.chat_template is None and (not hasattr(tokenizer, "default_chat_template") or tokenizer.default_chat_template is None):
