...
class DataArguments:
    ...
    # dict or str
    dataset_mixer: Optional[str] = field( #Dict[str, float]] = field(
        default=None,
    ...
    llama_chat_template: bool = field(
        default=False,
        metadata={"help": ("Whether to use the default chat template for the llama-3.1-8b.")},
    )
